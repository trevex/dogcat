...
type ScoreFunc func(context.Context, *db.ScoreMutation) (db.Value, error)

// Mutate calls f(ctx, m).
func (f ScoreFunc) Mutate(ctx context.Context, m db.Mutation) (db.Value, error) {
	mv, ok := m.(*db.ScoreMutation)
	if !ok {
		return nil, fmt.Errorf("unexpected mutation type %T. expect *db.ScoreMutation", m)
	}
	return f(ctx, mv)
}
